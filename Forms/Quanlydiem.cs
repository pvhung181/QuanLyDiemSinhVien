...
namespace QuanLyDiemSinhVien.Forms
{
    public partial class Quanlydiem : Form
    {
...

        {
            ...
            if (MessageBox.Show("Thời khóa biểu sẽ in học kỳ " + hocky.Text + " của lớp " + malop.Text + ". Bạn có muốn in không ?",
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Vui lòng điền đầy đủ thông tin lớp, môn, lần thi để xuất excel", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
